...
def tabs_2reagents(self):
    ...
    self.reaction_2reagents_inside.setAlignment(Qt.AlignTop)
    ...
    self.button_step1_2R = QPushButton("Step #1 - Minimum Enumeration Library")
    self.button_step2_2R = QPushButton("Step #2 - Focused Enumeration Library")
    ...
    self.button_step2_2R.clicked.connect(lambda: CB_test(self))
    ...
    self.tabsA_2R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_A2R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_A2R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_A2R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_A2R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_A2R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_A2R.addWidget(self.image_A2R)

    self.mw_A2R = QLabel()
    self.mw_A2R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.tabsB_2R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_B2R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_B2R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_B2R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_B2R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_B2R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_B2R.addWidget(self.image_B2R)

    self.mw_B2R = QLabel()
    self.mw_B2R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
