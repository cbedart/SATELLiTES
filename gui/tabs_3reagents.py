...
from PyQt5.QtGui import QFont, QPixmap, QImage, QTextCursor, QIcon
...
def generate_image_step1_A3R(self):
    ...
    if molecule:
        image = Draw.MolToImage(molecule, size=(300,75))
...
def tabs_3reagents(self):
    ...
    self.reaction_3reagents_inside.setAlignment(Qt.AlignTop)
    ...
    self.button_step1_3R = QPushButton("Step #1 - Minimum Enumeration Library")
    self.button_step2_3R = QPushButton("Step #2 - Focused Enumeration Library")
    self.button_step3_3R = QPushButton("Step #3 - Focused Enumeration Library")
    ...
    self.tabsA_step1_3R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_step1_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_step1_A3R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_step1_A3R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_step1_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_step1_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_step1_A3R.addWidget(self.image_step1_A3R)

    self.mw_step1_A3R = QLabel()
    self.mw_step1_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.tabsB_step1_3R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_step1_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_step1_B3R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_step1_B3R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_step1_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_step1_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_step1_B3R.addWidget(self.image_step1_B3R)

    self.mw_step1_B3R = QLabel()
    self.mw_step1_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.tabsC_step1_3R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_step1_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_step1_C3R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_step1_C3R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_step1_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_step1_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_step1_C3R.addWidget(self.image_step1_C3R)

    self.mw_step1_C3R = QLabel()
    self.mw_step1_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.label_step2.setAlignment(Qt.AlignHCenter)
    ...
    self.tabsA_step2_3R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_step2_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_step2_A3R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_step2_A3R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_step2_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_step2_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_step2_A3R.addWidget(self.image_step2_A3R)

    self.mw_step2_A3R = QLabel()
    self.mw_step2_A3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.tabsB_step2_3R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_step2_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_step2_B3R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_step2_B3R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_step2_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_step2_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_step2_B3R.addWidget(self.image_step2_B3R)

    self.mw_step2_B3R = QLabel()
    self.mw_step2_B3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.tabsC_step2_3R_title.setAlignment(Qt.AlignCenter)
    ...
    self.label1_step2_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignVCenter)
    ...
    self.layout2_step2_C3R.setAlignment(Qt.AlignVCenter)
    ...
    self.label2_step2_C3R.setAlignment(Qt.AlignHCenter)
    ...
    self.layout3_step2_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.image_step2_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    self.layout3_step2_C3R.addWidget(self.image_step2_C3R)

    self.mw_step2_C3R = QLabel()
    self.mw_step2_C3R.setAlignment(Qt.AlignHCenter | Qt.AlignTop)
    ...
    self.label_step3.setAlignment(Qt.AlignHCenter)
