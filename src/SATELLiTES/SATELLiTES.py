...
from PyQt5.QtCore import Qt, QTimer, QSize, QFile, QUrl
from PyQt5.QtGui import QFont, QPixmap, QImage, QTextCursor, QIcon, QDesktopServices
...
installdir_SATELLiTES = [i for i in sys.path if "site-packages" in i][0] + "/SATELLiTES/"
...
def launch_function(reagentsA, reagentsB, reagentsC, reaction, output_path, nb_cpu, modeA, modeB, modeC, inputA, inputB, inputC, step, step_path):
    ...
    # return ""
    if modeC == "":
        CB_run_2reagents(reagentsA, reagentsB, reaction, output_path, nb_cpu, modeA, modeB, inputA, inputB, window, app, job_name = "SATELLiTES")
    else:
        CB_run_3reagents(reagentsA, reagentsB, reagentsC, reaction, output_path, nb_cpu, modeA, modeB, modeC, inputA, inputB, inputC, step, step_path, window, app, job_name = "SATELLiTES")
...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("SATELLiTES - Version 1.0")
        ...
        self.left_column_widget.setFixedWidth(100)  # Fixed width for left column
        ...
        self.layout_header.addWidget(self.label_logo, alignment=Qt.AlignCenter)
        ...
        self.right_column_widget.setFixedWidth(100)  # Fixed width for right column
        ...
        self.reaction_tabs.setStyleSheet("QTabBar::tab { color:black; height: 30px; width: 300px;}")
    ...
    # FUNCTIONS
    def open_help(self):
        url = QUrl('https://github.com/cbedart/SATELLiTES/blob/main/SATELLiTES%20Wiki.pdf')
